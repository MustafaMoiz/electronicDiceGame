...
void loop() {
  ...
  if(button2==HIGH || buttonFlag[0]==1)
  {
    lc.setDigit(0,0,random(1,7),false);
    buttonFlag[0]=1;
  }

  if(button3==HIGH || buttonFlag[1]==1)
  {
    lc.setDigit(0,1,random(1,7),false);
    buttonFlag[1]=1;
  }

  if(button4==HIGH || buttonFlag[2]==1)
  {
    lc.setDigit(0,2,random(1,7),false);
    buttonFlag[2]=1;
  }

  if(button5==HIGH || buttonFlag[3]==1)
  {
    lc.setDigit(0,3,random(1,7),false);
    buttonFlag[3]=1;
  }

  if(button6==HIGH || buttonFlag[4]==1)
  {
    lc.setDigit(0,4,random(1,7),false);
    buttonFlag[4]=1;
  }

  if(button7==HIGH || buttonFlag[5]==1)
  {
    lc.setDigit(0,5,random(1,7),false);
    buttonFlag[5]=1;
  }

  if(button8==HIGH || buttonFlag[6]==1)
  {
    lc.setDigit(0,6,random(1,7),false);
    buttonFlag[6]=1;
  }

  if(button9==HIGH || buttonFlag[7]==1)
  {
